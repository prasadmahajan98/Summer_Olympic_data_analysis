...
st.sidebar.image('https://cdn.pixabay.com/photo/2013/02/15/10/58/blue-81847_960_720.jpg')
...
if user_menu == 'Country Wise Analysis':
    ...
    st.title(selected_country + ' Excellent is following sport')
    st.pyplot(fig)
